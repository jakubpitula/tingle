  ...
  const onToggleSwitch = () => setIsSwitchOn(!isSwitchOn);
    ...
    return(
        ...
        <SafeAreaView>
            ...
            <Appbar.Header>
                <Appbar.Action icon='arrow-left-thick'  onPress={() => navigation.navigate('Registration')}/>
                <Appbar.Content title="Preferences" color='#FF356B' titleStyle={{fontWeight: 'bold'}}/>
                ...
                Only show people in this range     <Switch value={isSwitchOn} onValueChange={onToggleSwitch}/>
                </Text> 
